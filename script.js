...
function selectWithdrawMethod(method) {
  ...
  document.querySelectorAll('#withdrawMethodTabs .method-tab').forEach((btn) => {
    ...
    btn.style.color = active ? '#0f172a' : 'var(--fg)';
  });
...
function spinPrizeRowHtml(p, i) {
  return `<div class="spin-prize-row" style="display:flex;flex-direction:column;gap:6px;margin-bottom:10px;padding:8px;border:1px solid var(--border);border-radius:10px;" data-idx="${i}">
    <div style="display:flex;gap:6px;align-items:center;">
      <select class="spin-prize-type" style="flex:1;padding:8px;border-radius:8px;border:1px solid var(--border);background:#0f172a;color:var(--fg);font-family:inherit;">
      ...
      <input class="spin-prize-amount" type="number" step="any" value="${p.amount}" placeholder="Amount" style="flex:1;padding:8px;border-radius:8px;border:1px solid var(--border);background:#0f172a;color:var(--fg);">
      <input class="spin-prize-weight" type="number" value="${p.weight}" placeholder="Weight" style="flex:1;padding:8px;border-radius:8px;border:1px solid var(--border);background:#0f172a;color:var(--fg);">
